...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("GuLingTong".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["remoteteach.cloudgn.com"];
pub const RS_PUB_KEY: &str = "Yxx8CLJfnYyT4avERyKLSDHjKH8RYYaAdAhy1XC7nHw=";
