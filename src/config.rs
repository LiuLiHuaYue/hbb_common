...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
            let mut map = HashMap::new();
            map.insert("password".into(), "daohe000DAOHE..".into());
            RwLock::new(map)
        };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rd.beijingdaohe.com"];
pub const RS_PUB_KEY: &str = "gu5RjpRedoh2NUJPdk4RxHvQ+OyggQcTJ1JEiof8SFI=";
