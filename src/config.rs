...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("zcmDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["service.zhaocaimao789-service.com"];
pub const RS_PUB_KEY: &str = "OVgK0Z1p3P7xR9psJ0rm2IfWz5Ty149xTl9H77v99Ko=";
