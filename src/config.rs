...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
            let mut map = HashMap::new();
            map.insert("password".into(), "Hello25@".into());    //固定密码
            RwLock::new(map)
        };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["47.111.230.93"];
pub const RS_PUB_KEY: &str = "tj+4QxxsP9nio62HHQLK6MbmGdmQPIr9ka3OQjBwDNk=";
